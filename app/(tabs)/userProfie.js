...
const createNewPost = async () => {
 ...
 // Assuming 'uname' is defined elsewhere
  ...
  try {
    ...
    // Prepare images, ensuring at least 4 are provided
    let images = [...selectedImages];
    if (images.length < 4) {
      // Handle the case where less than 4 images are selected (e.g., fill with placeholder)
    ...
    // Append other post details to FormData
    ...
    // Error handling based on where the error occurred
    if (error.response) {
